...
class PytorchTrainingAndTest:
    ...
    def run_model(self, exp_num, model, model_name, database_name, train, validation, test, learning_rate, num_epochs, num_class=2):
        '''
        ...
        trainer.test(model=ligh_model, dataloaders=test)
        metrics = trainer.logged_metrics
