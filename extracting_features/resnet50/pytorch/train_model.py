...
class PytorchTrainingAndTest:
    ...
    def run_model(self, exp_num, model, model_name, database_name, train, val, test, learning_rate, num_epochs, num_class=2):
        '''
          ...
          params:
            ...
            - val: dataloader of the validation
        ...
        timer = CustomTimeCallback("./metrics/time/train_time_{}-{}.csv".format(model_name, database_name),
                                       "./metrics/time/val_time_{}-{}.csv".format(model_name, database_name))
